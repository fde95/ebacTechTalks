...
const dataDoEvento = new Date ("Dec 12, 2023 20:00:00"); //apontando data e hora para uma ação futura
...
const contaAsHoras = setInterval(function(){
    ...
    document.getElementById('contador').innerHTML = ` começa em <b style="color: yellow;"> ${diasAteEvento}d ${horasAteEvento}h ${minutosAteEvento}m ${segundosAteEvento}s </b>`;

    if (distanciaTempoEvento < 0) {
        clearInterval(contaAsHoras);
        document.getElementById('contador').innerHTML = ' <b style="color: red;">já acabou! </b><br> Mas calma, logo lançaremos a nova edição'
    }
